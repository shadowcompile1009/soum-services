...
export interface V2ServiceClient {
  ...
  getPermissions(request: GetPermissionsRequest, metadata?: Metadata): Observable<GetPermissionsResponse>;

  getOrderDetail(request: GetOrderDetailRequest, metadata?: Metadata): Observable<GetOrderDetailResponse>;

  getDmUser(request: GetDmUserRequest, metadata?: Metadata): Observable<GetDmUserResponse>;

  getDmUsers(request: GetDmUsersRequest, metadata?: Metadata): Observable<GetDmUsersResponse>;

  getUsersByPhone(request: GetUsersByPhoneRequest, metadata?: Metadata): Observable<GetUsersByPhoneResponse>;

  updateHighestBid(request: UpdateHighestBidRequest, metadata?: Metadata): Observable<UpdateHighestBidResponse>;

  getProducts(request: GetProductsRequest, metadata?: Metadata): Observable<GetProductsResponse>;
  ...
  getProductStatuses(request: GetProductStatusesRequest, metadata?: Metadata): Observable<GetProductStatusesResponse>;

  updateLogisticService(
    request: UpdateLogisticServiceRequest,
    metadata?: Metadata,
  ): Observable<UpdateLogisticServiceResponse>;

  getBidSummary(request: GetBidSummaryRequest, metadata?: Metadata): Observable<GetBidSummaryResponse>;

  getViewedProducts(request: GetViewedProductsRequest, metadata?: Metadata): Observable<GetViewedProductsResponse>;
  ...
  createNewUser(request: CreateNewUserRequest, metadata?: Metadata): Observable<CreateNewUserResponse>;

  updateInactiveUser(request: UpdateInactiveUserRequest, metadata?: Metadata): Observable<UpdateInactiveUserResponse>;

  cancelOrder(request: CancelOrderRequest, metadata?: Metadata): Observable<CancelOrderResponse>;

  getBanners(request: GetBannersRequest, metadata?: Metadata): Observable<GetBannersResponse>;

  getFeeds(request: GetFeedRequest, metadata?: Metadata): Observable<GetFeedsResponse>;

  updatePenaltyFlag(request: UpdatePenaltyFlagRequest, metadata?: Metadata): Observable<UpdatePenaltyFlagResponse>;
  ...
  getVariants(request: GetVariantsRequest, metadata?: Metadata): Observable<GetVariantsResponse>;
  ...
  getRecentlySoldProducts(
    ...
    metadata?: Metadata,
  ): Observable<GetViewedProductsResponse>;

  getSellerBadge(request: GetSellerBadgeRequest, metadata?: Metadata): Observable<GetSellerBadgeResponse>;

  getPromoCode(request: GetPromoCodeRequest, metadata?: Metadata): Observable<GetPromoCodeResponse>;

  setUserOtp(request: SetUserOTPRequest, metadata?: Metadata): Observable<SetUserOTPResponse>;

  checkUserOtp(request: CheckUserOTPRequest, metadata?: Metadata): Observable<CheckUserOTPResponse>;

  createSmsaTracking(request: CreateSMSATracking, metadata?: Metadata): Observable<CreateSMSATracking>;
}
...
export interface V2ServiceController {
  ...
  getDmUser(
    request: GetDmUserRequest,
    metadata?: Metadata,
  ): Promise<GetDmUserResponse> | Observable<GetDmUserResponse> | GetDmUserResponse;
  ...
  getFeeds(
    ...
    metadata?: Metadata,
  ): Promise<GetFeedsResponse> | Observable<GetFeedsResponse> | GetFeedsResponse;
