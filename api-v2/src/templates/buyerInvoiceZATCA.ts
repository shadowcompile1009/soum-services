const ZATCAinvoiceBuyerPDF = `<!DOCTYPE html>
<html>
...
<body>
  <div id="orderInvoice-en" class="invoice-box">
    <div class="container-fluid invoice-container">
        ...
        <table class="simple-table">
          <tr>
            <td class="simple-table">
              <image src='{{soum_logo}}' width="50" height="50" class="qrcode" />
            </td>
            <td class="color-imgs ar" >فاتورة ضريبية - TAX Invoice</td>
            <td class="simple-table">
              <image src='{{qr_code}}' width="50" height="50" class="qrcode" />
            </td>
          </tr>
        </table>
        <br>
        ...
        <div class="container-table">
          <table class="simple-table"  style="width: 50%;">
            <tr class="simple-table table-header-color">
              ...
              <td  class="ar simple-table height"><b>معلومات البائع </b></td>
            </tr>
            <tr>
              <td  class=" simple-table height">Seller Name</td>
              <td class="simple-table height">SOUM Trading Company شركة منصة سوم للتجارة  </td>
            ...
            <tr>
              ...
              <td class="ar simple-table height"> العنوان  </td>            </tr>
            <tr>
          ...
          <table class="simple-table "  style="width: 50%;">
            <tr class="simple-table table-header-color">
              ...
              <td  class=" simple-table height"></td>
              <td  class="ar simple-table height"><b>معلومات العميل  </b></td>
            </tr>
            <tr>
              <td  class=" simple-table height"> Buyer Name</td>
            ...
            <tr>
              ...
              <td  class="ar simple-table height">ضريبة القيمة المضافة</td>
            </tr>
            <tr>
              <td  class=" simple-table height">CR number</td>
              <td  class=" simple-table height">NA</td>
      ...
      <main>
        <div class="container-table"> <b>Product Listing price - Non Taxable</b>
          <span>سعر المنتج المعروض - غير خاضع لضريبة القيمة المضافة</span>
        </div>
              ...
              <table class="table bill-table full-width">
                <thead class="thead-light table-header-color">
                  <tr class="invoiceTableHeading">
                    <th class="service-title" style="width:15px !important;">
                      <span><b>Item</b></span>
                    </th>
                    <th class="service-title"> <span><b>Price (SAR)</b> </span></th>
                    <th class="service-title"> <span><b>Taxable amount (SAR) </b>
                      </span></th>
                    <th class="service-title"> <span><b>Discount (SAR)</b>
                      </span></th>
                    <th class="service-title"> <span><b>Taxable amount after discount (SAR)</b></span></th>
                    <th class="service-title">
                      <span><b>VAT on taxable amount after discount</b>
                      </span>
                    </th>
                    <th class="service-title">
                      <span><b>VAT (SAR)</b></span>
                    </th>
                    <th class="service-title">
                      <span><b>Net amount including VAT (SAR)</b></span>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr class="table-header-color">
                    <td class="model-name ar"> السلعة  </br>
                      </br>
                    </td>
                    <td class="model-name ar">(ریال) المبلغ </td>
                    <td class="model-name ar">(ریال) المبلغ الخاضع للضريبة</td>
                    <td class="model-name ar"> (ریال) الخصم  </td>
                    <td class="model-name ar">(ریال) المبلغ الخاضع للضريبة بعد الخصم </td>
                    <td class="model-name ar"> ضريبة القيمة المضيفة المطبقة على المبلغ بعد الخصم </td>
                    <td class="model-name ar">(ریال) الضريبة بالريال السعودي </td>
                    <td class="model-name ar">(ریال) صافي المبلغ شامل الضريبة
                    </td>
                  </tr>
                  <tr>
                    <td class="model-name" style="width:15px !important;">
                      {{order_detail.device_en}} - {{product}}
                    </td>
                    <td class="model-name">{{order_detail.unit_price}} </br> </td>
                    <td class="model-name">{{commission_detail.unit_price}}</br></td>
                    <td class="model-name">{{commission_detail.discount}} </br> </td>
                    <td class="model-name">{{commission_detail.unit_price_after_discount}}</br></td>
                    <td class="model-name"> 15%</br></td>
                    <td class="model-name">{{commission_detail.tax}}</td>
                    <td class="model-name">{{commission_detail.sub_total}}</td>
                  </tr>
                  {{{addOns}}}
                </tbody>
              </table>
        ...
        <div class="container-table"> <b>Commision - Taxable</b>
          <span>خدمة الوساطة - خاضعة لضريبة القيمة المضافة </span>
        </div>
        <div class="card">
          <div class="card-body px-0 padding-0">
            <div class="table-responsive">
              <table class="table bill-table full-width">
                <thead class="thead-light table-header-color">
                  <tr class="invoiceTableHeading">
                    ...
                    <th class="service-title"> <span><b>Unit price</b> </span></th>
                    <th class="service-title"> <span><b>Quantity</b><strong></span>
                ...
                <tbody>
                  <tr class="table-header-color">
                    ...
                    <td class="model-name ar">سعر الوحدة </td>
                    <td class="model-name ar">كمية</td>
                  ...
                  <tr>
                    ...
                    <td class="model-name">{{commission_detail.unit_price}}
                      </br> SAR ریال </td>
                    <td class="model-name">{{commission_detail.quantity}}
                    </td>
                    ...
                    <td class="model-name">{{commission_detail.tax}}
                      </br> SAR ریال </td>
                    <td class="model-name">{{commission_detail.sub_total}}
                      </br> SAR ریال </td>
                  </tr>
                </tbody>
              </table>
        ...
        <table class="simple-table " style="float:right;">
          <tr>
              <td class="simple-table">Total Non Taxable Amount</td>
              <td class="ar simple-table">إجمالي المبلغ غير الخاضع للضريبة </td>
              <td class="simple-table">{{order_detail.unit_price}} SAR</td>
          </tr>
          <tr>
              <td class="simple-table">Total Taxable Amount </td>
              <td class="ar simple-table">اجمالي المبلغ الخاضع للضريبة</td>
              <td class="simple-table">{{totalTaxable}} SAR</td>
          </tr>
          <tr>
              <td class="simple-table">Total Discount </td>
              <td class="ar simple-table">  اجمالي الخصم </td>
              <td class="simple-table">{{total_discount}} SAR</td>
          </tr>
          <tr>
              <td class="simple-table">Total Taxable Amount After Discount</td>
              <td class="ar simple-table"> اجمالي المبلغ الخاضع للضريبة بعد الخصم </td>
              <td class="simple-table">{{totalTaxableAfterDiscount}} SAR</td>
          </tr>
          <tr>
              <td class="simple-table">Total VAT</td>
              <td class="ar simple-table"> اجمالي ضريبة القيمة المضافة </td>
              <td class="simple-table">{{grandVatTotal}} SAR</td>
          </tr>
          <tr>
              <td class="simple-table">Delivery Charge</td>
              <td class="ar simple-table">تكلفة التوصيل </td>
              <td class="simple-table">{{delivery_fee}} SAR</td>
          </tr>
          <tr>
              <td class="simple-table">Total Amount including VAT</td>
              <td class="ar simple-table"> اجمالي المبلغ شامل ضريبة القيمة المضافة </td>
              <td class="simple-table">{{grandTotal}} SAR</td>
          </tr>
      </table>
      </main>
