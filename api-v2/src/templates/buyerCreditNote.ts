const buyerCreditNoteInvoiceSoumPDF = `
<!DOCTYPE html>
<html>
  ...
  <div id="orderInvoice-en" class="invoice-box">
    <div class="container-fluid invoice-container">
      <header>
        <table class="simple-table">
          <tr>
            ...
            <td class="color-imgs ar" >مذكرة الائتمان الضريبي - Tax Credit Note </td>
            <td class="simple-table">
        ...
        <div class="container-table">
          ...
          <table class="simple-table">
            <tr>
              <td class="simple-table">Credit Note No.</td>
              <td class="simple-table">{{credit_note_invoice_number}}</td>
            </tr>
            <tr>
          ...
          <table class="simple-table">
            <tr>
              ...
              <td class="simple-table ar">مذكرة الائتمان الضريبي  </td>
            </tr>
            <tr>
              <td class="simple-table">{{order_number}}</td>
      ...
      <main>
              ...
              <table class="table bill-table full-width">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="model-name">-{{order_detail.sub_total}}</br></td>
        ...
        <tr>
            <td class="simple-table">Total Non Taxable Amount </td>
            <td class="ar simple-table">إجمالي مبلغ غير مستحق الضريبه </td>
            <td class="simple-table">{{totalTaxable}}</td>
          </tr>
          <tr>
...
`;
export { buyerCreditNoteInvoiceSoumPDF };
