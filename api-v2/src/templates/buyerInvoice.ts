...
<html>
        ...
        <div id="orderInvoice-en" class="invoice-box">
          <div class="container-fluid invoice-container">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="col-sm--4 mb-4 mb-sm-0 logos">
                      <span class="text-7 bill-title-ar mb-0">فاتورة شراء منتج </span></br>
                      <span class="text-7 bill-title-en mb-0">Purchase Invoice</span>
                    </td>
            ...
            <main>
              <table class="rows order_table buyer-invoice-table-container">
                <tbody>
                  <tr>
                    <td class="col-4 mb-4 mb-sm-0 date-title width-3"><b> Invoice number</b></td>
                    <td class="col-4 mb-4 mb-sm-0 invoice-no-title width-4">{{invoice_number}}</td>
                  ...
                  <tr>
                    ...
                    <td class="col-4 mb-4 mb-sm-0 invoice-no-title width-4"> {{billed_by_seller}}</td>
                    ...
                    <table class="table bill-table full-width">
                      <thead class="thead-light">
                        <tr class="invoiceTableHeading">
                          ...
                          <th class="service-title"> <span><b>الخصم</b></br></br>Discount</strong></span>
                      ...
                      <tbody>
                        <tr>
                          <td class="model-name"><b>المنتج المسوق</b></br>
                            Item listed on Soum </br></br>
                            {{order_detail.device_en}}</br>
                          </td>
                          <td class="model-name">{{order_detail.unit_price}} </br> SAR ریال </td>
                          <td class="model-name">{{order_detail.discount}} </br> SAR ریال </td>
                          <td class="model-name">{{order_detail.unit_price_after_discount}} </br> SAR ریال </td>
                          <td class="model-name">{{order_detail.quantity}}</td>
                          <td class="model-name">{{order_detail.tax}} </br> SAR ریال </td>
                          <td class="model-name">{{order_detail.sub_total}} </br> SAR ریال </td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <hr>
                <table class="rows order_table buyer-invoice-table full-width">
                  <tbody>
                    <tr>
                  ...
                  <div class="table-responsive">
                    <table class="table bill-table full-width">
                      ...
                      <tbody>
                        <tr>
                          <td class="model-name">
                            <b>{{commission_detail.commission_ar}}</b></br></br>
