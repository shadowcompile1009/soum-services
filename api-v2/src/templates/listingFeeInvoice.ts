      ...
      <main>
        <div class="info-wrapper">
          <table class="eng-inv-info">
            <tr>
              ...
              <td>{{tax_invoice_number}}</td>
            </tr>
            <tr>
              <td class="">Invoice No.</td>
              <td>{{ZATCA_invoice_number}}</td>
            </tr>
            <tr>
          ...
          <table class="ar-inv-info">
            <tr>
              <td>{{tax_invoice_number}}</td>
              <td class="text-right text-bold">رقم طلب سوم</td>
            </tr>
            <tr>
              <td>{{ZATCA_invoice_number}}</td>
              <td class="text-right text-bold">رقم الفاتورة.</td>
            </tr>
            <tr>
              <td>{{issue_date}}</td>
              <td class="text-right text-bold">تاريخ إصدار الفاتورة</td>
            </tr>
          </table>
        </div>
        ...
        <div class="contact-wrapper">
          <table class="seller-table">
            <tr>
              ...
              <th colspan="3" class="service-title">
                Customer Information
              </th>
            </tr>
            <tr>
              <td class="">Seller Name</td>
              <td class="seller-info">SOUM Trading Company شركة تجارة سوم</td>
              <td class="text-right text-bold">البائع اسم</td>
              <td class="border-none border-left">Customer Name</td>
              <td class="border-none">{{bill_to}}</td>
              <td class="border-none text-right text-bold">سم العميل</td>
            </tr>
            <tr>
              <td class="">VAT number</td>
              <td class="">310985751500003</td>
              <td class="text-right text-bold">ضريبة القيمة المضافة</td>
              <td rowspan="5" class="border-none border-left">Address</td>
              <td rowspan="5" class="border-none">{{address}}</td>
              <td rowspan="5" class="border-none text-right text-bold">موقع</td>
            </tr>
            <tr>
              <td class="">CR#</td>
              <td class="">1010664186</td>
              <td class="text-right text-bold">رقم السجل التجاري</td>
            </tr>
            <tr>
              <td class="">Address</td>
              <td class="">
              ...
              <td class="text-right text-bold">موقع البائع</td>
            </tr>
            <tr>
              <td class="">Email</td>
              <td class="">
              ...
              <td class="text-right text-bold">البريد الإلكتروني</td>
            </tr>
            <tr>
              <td class="">Contact</td>
              <td class="">920035039</td>
              <td class="text-right text-bold">اتصال</td>
            </tr>
          </table>
        </div>
        <strong>Commission - Taxable</strong>
        <div class="card">
            ...
            <div class="table-responsive">
              <table class="table bill-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <th class="service-title">{{service_en}}</th>
                    <td class="model-name">{{unit_price}}</td>
                    <td class="model-name">{{discount}}</td>
                    <td class="model-name">
                      STD {{tax}}%
                    </td>
                    <td class="model-name">{{total_taxable_amount}}</td>
        ...
        <div class="summary-section">
          ...
          <table class="last-table">
            <tbody>
              <tr>
                <td class="date-title width-3">Total Unit Price</td>
