...
import { useOrdersTableV3 } from '@src/components/Shared/hooks';
import { QUERY_KEYS } from '@src/constants/queryKeys';

import { disputeOrdersColumn } from './helpers/columns';
import { getDisputeOrdersColumns } from './helpers/getDisputeOrdersColumns';

export function DisputeOrdersTable() {
  ...
  const {
    ...
    limit: apiLimit,
    offset,
  } = useOrdersTableV3({ submodule: 'new-dispute' });
  ...
  const columns = useMemo(
    () =>
      getDisputeOrdersColumns({
        columns: disputeOrdersColumn,
        queryKey: [
          QUERY_KEYS.dispute,
          String(apiLimit),
          String(offset),
