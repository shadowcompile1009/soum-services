...
export interface OrderColumnDeliveryV2 {
  accessor: DeepKeys<OrderV2>;
  header: string;
}

interface getDeliveryOrderColumnsProps {
  columns: OrderColumnDeliveryV2[];
  queryKey: string[];
}

export function getDeliveryOrderColumns(props: getDeliveryOrderColumnsProps) {
