...
import { payoutColumns2_0 } from './helpers/columns';
import { getPayoutColumns2_0 } from './helpers/getPayoutColumns2_0';

export function SellerPayoutTable2_0() {
  ...
  const {
    ...
    limit: apiLimit,
    offset,
  } = useOrdersTablePayout2_0({ submodule: EOrderModules.NEW_PAYOUT });
  ...
  const columns = useMemo(
    () =>
      getPayoutColumns2_0({
        ...
        columns: payoutColumns2_0,
        queryKey: [
          QUERY_KEYS.sellerPayouts,
          String(apiLimit),
          String(offset),
          String(search),
        ],
