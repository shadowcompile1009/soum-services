...
const AddonModal = (props: Props) => {
  const { isOpen, deviceModelId, onClose, isLoading, addon, refetch } = props;
  ...
  useEffect(() => {
    if (addon) {
      ...
      if (addon.type === 'warranty' && addon.sellerIds.length > 0) {
        setSelectedAddOns(
  ...
  const onSubmit = async (formValues: any) => {
    ...
    if (isGiftWrappingOrExtraPackaging) {
      ...
      formData.append('modelIds', deviceModelId);
  ...
  return (
    <CommonModal isOpen={isOpen} onClose={handleClose}>
      ...
      <Stack direction="vertical" gap="5">
        <Box paddingBottom={5} cssProps={{ borderBottom: '1px solid #E5E5E5' }}>
          <Stack
          ...
          >
            <Text color="static.black" fontSize="bigText" fontWeight="regular">
              {addon ? 'Edit Add-ons' : 'Add New Add-ons'}
            </Text>
            <IconContainer
              color="static.black"
              role="button"
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Stack direction="horizontal" gap="10">
            <Stack direction="vertical" gap="2" flex="1">
              <Box>
                <Text
                  fontWeight="regular"
                  fontSize="baseText"
              ...
              <Box>
                ...
                <Stack align="center">
                  <Box marginTop={2}>
                    <FileUploadWrapper
                      ...
                      style={{
                        backgroundColor: isGiftWrappingOrExtraPackaging
                          ? '#f2f2f2'
                          : 'white',
                        borderColor: isGiftWrappingOrExtraPackaging
                          ? '#f2f2f2'
                          : '#0071f2',
                      }}
                    >
                      ...
                      <FileUploadIcon
                        htmlFor="file-upload"
                        style={{
                          color: isGiftWrappingOrExtraPackaging
                            ? '#ccc'
                            : '#007bff',
                        }}
                      >
                    ...
                    {isSavePressed &&
                    !isGiftWrappingOrExtraPackaging &&
                    !fileName ? (
                      <Text
                        fontWeight="regular"
                        fontSize="baseText"
              ...
              <Box>
                ...
                <Box marginTop={2}>
                  <FormField htmlFor="nameAr-input">
              ...
              <Box>
                ...
                <Box marginTop={2}>
                  <FormField htmlFor="taglineAR-input">
                    <Box cssProps={{ position: 'relative' }}>
                      <Input
                        {...register('tagLine_ar')}
              ...
              <Box>
                ...
                <Box marginTop={2}>
                  <FormField htmlFor="period-input">
                    <Box cssProps={{ position: 'relative' }}>
                      <Input
                        {...register('period')}
                        id="period-input"
                        placeholder="Enter Number"
                        defaultValue={
                          Number.isNaN(data?.validity) ? '' : data?.validity
                        }
                        type="number"
                        onChange={(e) =>
                          setData({
              ...
              <Box>
                ...
                <Box marginTop={2}>
                  <FormField htmlFor="descriptionAR-input">
                    <Box cssProps={{ position: 'relative' }}>
                      <Textarea
                        ...
                        onChange={(e) =>
                          setData({
                            ...data,
                            descriptionAr: (e.target as HTMLTextAreaElement)
                              .value,
                          } as IGetAddonsResponse)
                        }
                        disabled={isGiftWrappingOrExtraPackaging}
            ...
            <Stack direction="vertical" gap="2" flex="1">
              <Box cssProps={{ opacity: 0, PointerEvent: 'none' }}>
                <Text
                  fontWeight="regular"
                  fontSize="baseText"
                  color="static.black"
                ...
                <Box cssProps={{ height: '38px' }} marginTop={2}></Box>
              </Box>
              <Box cssProps={{ opacity: 0, PointerEvent: 'none' }}>
                <Text
                  fontWeight="regular"
                ...
                <Box marginTop={2}>
                  <FormField htmlFor="nameEn-input">
                    <Box
                      cssProps={{
                        position: 'relative',
                        opacity: 0,
              ...
              {selectedAddOns?.value === '2' ? (
                <Box>
                  ...
                  <Stack flex="1">
                    <Box marginTop={2} cssProps={{ width: '100%' }}>
                      <FormField htmlFor="sellers-input">
                        <Box cssProps={{ position: 'relative' }}>
                          <Input
                            {...register('sellers_id', {
                              required:
                                selectedAddOns?.value === '2' ? true : false,
                            })}
                            style={{
                              paddingRight: '44px',
                              borderColor:
                                selectedAddOns?.value === '2' ? '#0071F2' : '',
                            }}
                            id="sellers-input"
                            placeholder="Enter Sellers ID"
                            defaultValue={
                              data ? data?.sellerIds?.join(',') : ''
                            }
                            onChange={(e) =>
                              setData({
                                ...data,
              ...
              <Box>
                ...
                <Box marginTop={2} cssProps={{ alignContent: 'center' }}>
                  <Select
                    isDisabled={false}
                    value={getValueFromSaved(
              ...
              <Box>
                ...
                <Box marginTop={2}>
                  <FormField htmlFor="taglineEN-input">
                    <Box cssProps={{ position: 'relative' }}>
                      <Input
                        {...register('tagLine_en')}
                        style={{ paddingRight: '44px' }}
              ...
              <Box>
                ...
                <Box marginTop={2}>
                  <FormField htmlFor="descriptionEN-input">
                    <Box cssProps={{ position: 'relative' }}>
                      <Textarea
                        ...
                        onChange={(e) =>
                          setData({
                            ...data,
                            descriptionEn: (e.target as HTMLTextAreaElement)
                              .value,
                          } as IGetAddonsResponse)
                        }
                        disabled={isGiftWrappingOrExtraPackaging}
