...
import { EditOrderDetails } from '@src/components/Order';
...
export async function getServerSideProps(ctx: NextPageContext) {
  ...
  await queryClient.prefetchQuery([QUERY_KEYS.NCTReasons, id], () =>
    Order.getNCTReasonByOrderId(id as string)
  );
...
EditOrderDetailsPage.getLayout = WithShellLayout;
