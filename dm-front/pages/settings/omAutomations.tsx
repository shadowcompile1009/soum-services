...
import { OMAutomationSettings } from '@/components/Settings';
...
const breadcrumbRoutes = {
  ...
  OMAutomation: {
    title: BREADCRUMBS.OMAUTOMATION,
  },
};

function OMAutomationSettingsPage() {
  return (
    <>
...
export async function getServerSideProps(ctx: NextPageContext) {
  ...
  await queryClient.prefetchQuery([QUERY_KEYS.omAutomationSettings], () =>
...
OMAutomationSettingsPage.getLayout = WithShellLayout;

export default OMAutomationSettingsPage;
