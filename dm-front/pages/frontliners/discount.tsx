...
import { DiscountListingTable } from '@/components/Frontliners';
...
function FrontlinerDiscountPage() {
  return (
    <>
      <Stack
...
export async function getServerSideProps(ctx: NextPageContext) {
  ...
  await queryClient.prefetchQuery(
    [QUERY_KEYS.flaggedListingDiscount, page, size],
    () =>
...
FrontlinerDiscountPage.getLayout = WithShellLayout;

export default FrontlinerDiscountPage;
