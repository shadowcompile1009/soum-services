...
import { PositiveListingTable } from '@/components/Frontliners';
...
const breadcrumbRoutes = {
  ...
  positive: {
    title: BREADCRUMBS.POSITIVE,
  },
};

function FrontlinerPositivePage() {
  return (
    <>
      <Stack
...
export async function getServerSideProps(ctx: NextPageContext) {
  ...
  await queryClient.prefetchQuery(
    [QUERY_KEYS.flaggedListingPositive, page, size],
    () =>
...
FrontlinerPositivePage.getLayout = WithShellLayout;

export default FrontlinerPositivePage;
