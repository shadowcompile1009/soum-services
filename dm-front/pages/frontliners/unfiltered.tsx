...
import { NonFilteredTable } from '@/components/Frontliners';
...
const breadcrumbRoutes = {
  ...
  unfiltered: {
    title: BREADCRUMBS.UNFILTERED,
  },
};

function FrontlinerUnfilterdPage() {
  return (
    <>
      <Stack
...
FrontlinerUnfilterdPage.getLayout = WithShellLayout;

export default FrontlinerUnfilterdPage;
