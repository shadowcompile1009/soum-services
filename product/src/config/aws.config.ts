...
export default registerAs('aws', () => ({
  ...
  fileAwsS3: process.env.AWS_S3_REGION,
  fileAccessKey: process.env.AWS_S3_ACCESS_KEY_ID,
  fileSecretAccessKey: process.env.AWS_S3_SECRET_ACCESS_KEY,
  fileBucketName: process.env.ASSET_AWS_S3_BUCKET_NAME,
  fileSessionToken: process.env.AWS_SESSION_TOKEN,
}));
