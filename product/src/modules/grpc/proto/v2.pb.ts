...
export interface V2ServiceClient {
  ...
  getUserLastOrderData(request: GetUserDataRequest): Observable<GetUserLastOrderDataResponse>;

  submitRating(request: SubmitRatingRequest): Observable<SubmitRatingResponse>;

  getCategoryModelsCount(request: GetVariantsRequest): Observable<GetCategoryModelsCountResponse>;
}
...
export interface V2ServiceController {
  ...
  getUserLastOrderData(
    request: GetUserDataRequest,
  ): Promise<GetUserLastOrderDataResponse> | Observable<GetUserLastOrderDataResponse> | GetUserLastOrderDataResponse;

  submitRating(
    request: SubmitRatingRequest,
  ): Promise<SubmitRatingResponse> | Observable<SubmitRatingResponse> | SubmitRatingResponse;

  getCategoryModelsCount(
    request: GetVariantsRequest,
  ):
    | Promise<GetCategoryModelsCountResponse>
    | Observable<GetCategoryModelsCountResponse>
